...
import de.cacheoverflow.krypton.asn1.ASN1OctetString
...
data class PrivateKeyInfo(val version: Int, val algorithmIdentifier: AlgorithmIdentifier, val privateKey: ASN1OctetString)
